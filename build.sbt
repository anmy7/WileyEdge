...
val flatSpec="org.scalatest" %% "scalatest-flatspec" % "3.2.14"
val funSpec="org.scalatest" %% "scalatest-funspec" % "3.2.14"
val wordSpec="org.scalatest" %% "scalatest-wordspec" % "3.2.14"
