...
class LoadData {
  ...
  loadAccountsFromDatabase(bofa)
  loadLoansFromDatabase(bofa)
  loadCreditCardsFromDatabase(bofa)

  def readFromFile: scala.Array[String] = {
    var data: scala.Array[String] = scala.Array()
    Source.fromFile("C:\\Users\\Nico\\IdeaProjects\\WileyEdge\\src\\main\\scala\\com\\training\\scalaProject\\Variables.txt").getLines().foreach((element) => {
  ...
  def loadAccountsFromDatabase(bank: Bank): Unit = {
    val url = "jdbc:mysql://localhost:3306/banking"
    val username = "root"
    val password = "root"
    // connection instance creation
  ...
  def loadLoansFromDatabase(bank: Bank): Unit = {
    val url = "jdbc:mysql://localhost:3306/banking"
    val username = "root"
    val password = "root"
    // connection instance creation
  ...
  def loadCreditCardsFromDatabase(bank: Bank): Unit = {
    val url = "jdbc:mysql://localhost:3306/banking"
    val username = "root"
    val password = "root"
    // connection instance creation
